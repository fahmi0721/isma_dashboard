...
@section("page-title", "TAMBAH DATA ENTITAS | MONITORING")
@section('custom_css')
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Tambah data entitas </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis" id="jenis" class='form-select'>
                            ...
                            <option value="berelasi">Berelasi</option>
                        </select>
                    </div>
