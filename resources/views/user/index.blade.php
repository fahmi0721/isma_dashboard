...
@section("page-title", "DATA USER | MONITORING")
@section("page-header")
...
<div class="row">
    <div class='col-12'>
        <div class='pull-right' style='margin-bottom:5px'>
            <a href="{{ route('user.form-tambah') }}" class="btn btn-gradient-info btn-icon-text" data-bs-toggle='tooltip' title='Tambah Data'>
       ...
       $('#data').DataTable({
            ...
            columns: [
                ...
                { data: 'id', name: 'aksi',"orderable": false, className: "text-center", 'searchable':false, render: function (data, type, row, meta) {
                    let aksi = "<a class='badge badge-pill badge-primary' data-bs-toggle='tooltip' href='{{ route('user.form-edit') }}?id="+row.id+"' title='Edit Data'><i class='mdi mdi-tooltip-edit'></i></a> <a class='badge badge-pill badge-danger' data-bs-toggle='tooltip' onclick=\"delete_data('"+row.id+"')\" title='Hapus Data'><i class='fa fa-trash'></i></a>";
