...
@section("page-title", "TAMBAH DATA PERIODE | MONITORING")
@section('custom_css')
<style>
    div.datepicker-days {
        /* display: none; */
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Tambah dana periode </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    @csrf
                    @method("post")
                    <div class="form-group">
                        <label for="periode">Priode</label>
                        <input type="text" class="form-control"  autocomplete="off"  maxlength="15" name='periode' id="periode" placeholder="Periode">
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <textarea type="text" maxlength="100" class="form-control" name='keterangan' id="keterangan" placeholder="Keterangan"></textarea>
                    </div>
