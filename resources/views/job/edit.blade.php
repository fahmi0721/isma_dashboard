...
@section("page-title", "EDIT DATA JABATAN | MONITORING")
@section('custom_css')
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  value="{{ $data['jabatan']->nama }}"maxlength="100" name='nama' id="nama" placeholder="Nama">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @foreach($data['job_type'] as $job_type)
                            <option value="{{ $job_type->id }}" @if($data['jabatan']->job_type_id == $job_type->id) selected @endif >{{ $job_type->nama }}</option>
                        @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" maxlength="100" class="form-control" name='deskripsi' id="deskripsi" placeholder="Deskripsi">{{ $data['jabatan']->deskripsi }}</textarea>
                    </div>
