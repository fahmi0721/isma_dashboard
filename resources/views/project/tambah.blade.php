...
@section("page-title", "TAMBAH DATA PROJECT | MONITORING")
@section('custom_css')
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Tambah data project </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    @csrf
                    @method("post")
                    <div class="form-group">
                        <label for="kode_project">Kode Project</label>
                        <input type="text" class="form-control"  maxlength="50" name='kode_project' id="kode_project" placeholder="Kode Project">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @foreach($data['kategori_project'] as $kategori_project)
                            <option value="{{ $kategori_project->id }}">{{ $kategori_project->nama }}</option>
                        @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" maxlength="10" autocomplete=off class="form-control" name='valid_from' id="valid_from" placeholder="Valid From">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class='fa fa-calendar-o'></i></span>
                            </div>
                            <input type="text" maxlength="10" class="form-control" name='valid_to' id="valid_to" placeholder="Valid To">
                        </div>
                    </div>
