...
@section("page-title", "TAMBAH DATA KATEGORI PROJECT | MONITORING")
@section('custom_css')
...
<div class="page-header">
    ...
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('kategori_project') }}">Kategori Project</a> </li>
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Tambah data kategori project </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    ...
                    <a href="{{ route('kategori_project') }}" class="btn btn-light"><i class="mdi mdi-reply btn-icon-prepend"></i> Kembali</a>
                </form>
            </div>
        </div>
    </div>
...
<script>
    proses_data = function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "{{ route('kategori_project.save') }}",
            data    : iData,
            chace   : false,
            beforeSend  : function (){
