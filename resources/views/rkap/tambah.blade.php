...
@section("page-title", "TAMBAH DATA RKAP | MONITORING")
@section('custom_css')
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Tambah data rkap </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    @csrf
                    @method("post")
                    <div class="form-group">
                        <label for="tahun">Tahun</label>
                        <input type="text" class="form-control"  maxlength="4" name='tahun' id="tahun" placeholder="Tahun">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  maxlength="20" name='laba_rugi' id="laba_rugi" placeholder="Laba Rugi">
                    </div>
