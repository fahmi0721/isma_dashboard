...
@section("page-title", "EDIT DATA PBL | MONITORING")
@section('custom_css')
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Edit data PBL </p>
                <form class="forms-sample" id="form_data" action="javascript:void(0)">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ number_format($data->pendapatan,0,',','.') }}"  maxlength="20" name='pendapatan' id="pendapatan" placeholder="Pendapatan">
                    </div>

                    <div class="form-group">
                        <label for="biaya">Biaya</label>
                        <input type="text" class="form-control" value="{{ number_format($data->biaya,0,',','.') }}"  maxlength="20" name='biaya' id="biaya" placeholder="Biaya">
                    </div>

                    <div class="form-group">
                        <label for="laba_rugi">Laba Rugi</label>
                        <input type="text" class="form-control"  maxlength="20" value="{{ number_format($data->laba_rugi,0,',','.') }}" name='laba_rugi' id="laba_rugi" placeholder="Laba Rugi">
                    </div>
                    ...
                    <a href="{{ route('pbl') }}" class="btn btn-light"><i class="mdi mdi-reply btn-icon-prepend"></i> Kembali</a>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    function validasi(){
        var id_form = ["#pendapatan","biaya","laba_rugi"];
